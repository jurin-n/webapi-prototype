...
public class JPADataSetUtilTest {
	 ...
	 */
	@Test
	public void SQL実行テスト() throws SAXException, IOException, ParserConfigurationException {
		JPADataSetUtil sut = new JPADataSetUtil();
		sut.setUpDataSetXML(System.getProperty("user.dir") + "/src/test/resources/jpa-dataset.xml");
